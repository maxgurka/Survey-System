...
namespace Tengella.Survey.Data.Migrations
{
    ...
    [Migration("20230812000156_RecipientLists")]
    partial class RecipientLists
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipientRecipientList", b =>
                {
                    b.Property<int>("RecipientListsId")
                        .HasColumnType("int");

                    b.Property<int>("RecipientsId")
                        .HasColumnType("int");

                    b.HasKey("RecipientListsId", "RecipientsId");

                    b.HasIndex("RecipientsId");

                    b.ToTable("RecipientRecipientList");
                });
            ...
            modelBuilder.Entity("Tengella.Survey.Data.Models.RecipientList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RecipientRecipientList", b =>
                {
                    b.HasOne("Tengella.Survey.Data.Models.RecipientList", null)
                        .WithMany()
                        .HasForeignKey("RecipientListsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tengella.Survey.Data.Models.Recipient", null)
                        .WithMany()
